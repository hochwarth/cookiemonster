    ...
    [
        ...
        'children' => [
            ...
            [
                'name' => 'mask_info',
                'type' => 'text',
                'label' => __('Kurzer Hinweis zu weiterführenden Informationen'),
                'value' => __('Weitere Informationen finden Sie hier:'),
                'description' => __('Wird in der Inhaltsmaske unten bei den rechtlichen Links angezeigt.'),
                'useLanguages' => true,
                'columnWidth' => 40,
            ],
            // --- Notwendige Cookies ---
    ...
    [
        ...
        'children' => [
            [
                ...
                'description' => __('Verifizierungsschlüssel für die Google Search Console'),
                'value' => '',
            ],
        ],
    ],
        ...
        'children' => [
                ...
                'children' => [
                    [
                        ...
                        'children' => [
                            ...
                            [
                                'type' => 'fieldset',
                                'label' => __('Zugehöriger Cookie'),
                                'name' => 'ga_cookie',
                                'showIf' => 'ga_property_id!=""',
                                'children' => [
                                    [
                                        'name' => 'ga_cookie_category',
                                        'type' => 'asmSelect',
                                        'label' => __('Cookie-Kategorien'),
                                        'description' => __('Cookie-Kategorien, denen dieser Trackingcode zugehörig ist. Es können mehrere Kategorien ausgewählt werden.'),
                                        'notes' => __('ODER-Verknüpfung: Der Trackingcode wird geladen, sobald einer der ausgewählten Kategorien zugestimmt wurde. Wird keine Kategorie ausgewählt, wird der Trackingcode ausgegeben, wenn den Statistik-Cookies zugestimmt wird.'),
                                        'columnWidth' => 50,
                                        'options' => [
                                            'essential' => __('Notwendige Cookies'),
                                            'functional' => __('Funktionelle Cookies'),
                                            'statistics' => __('Statistik-Cookies'),
                                            'marketing' => __('Marketing-Cookies'),
                                            'external' => __('Externe Inhalte'),
                                        ],
                                        'value' => [],
                                    ],
                                    [
                                        ...
                                        'type' => 'text',
                                        'label' => __('Cookie-ID'),
                                        'description' => __('ID des Cookies oder der Cookie-Gruppe, welche zugehörig zum Trackingcode ist.'),
                                        'notes' => __('Die ID muss mit der ID des Cookies bzw. der Cookie-Gruppe (`Name`) übereinstimmen. Bei mehreren ausgewählten Kategorien muss eine gleichnamige Cookie-Gruppe in jeder dieser Kategorien angelegt werden, damit der Trackingcode dort im Banner sichtbar ist.'),
                                        'columnWidth' => 50,
                                        'value' => '',
                                    ],
                                ],
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'type' => 'fieldset',
                        'label' => __('Zugehöriger Cookie'),
                        'name' => 'linkedin_insight_cookie',
                        'showIf' => 'linkedin_insight_id!=""',
                        'children' => [
                            [
                                'name' => 'linkedin_insight_cookie_category',
                                'type' => 'asmSelect',
                                'label' => __('Cookie-Kategorien'),
                                'description' => __('Cookie-Kategorien, denen dieser Trackingcode zugehörig ist. Es können mehrere Kategorien ausgewählt werden.'),
                                'notes' => __('ODER-Verknüpfung: Der Trackingcode wird geladen, sobald einer der ausgewählten Kategorien zugestimmt wurde. Wird keine Kategorie ausgewählt, wird der Trackingcode ausgegeben, wenn den Statistik-Cookies zugestimmt wird.'),
                            ...
                            [
                                'name' => 'linkedin_insight_cookie_id',
                                'type' => 'text',
                                'label' => __('Cookie-ID'),
                                'description' => __('ID des Cookies oder der Cookie-Gruppe, welche zugehörig zum Trackingcode ist.'),
                                'notes' => __('Die ID muss mit der ID des Cookies bzw. der Cookie-Gruppe (`Name`) übereinstimmen. Bei mehreren ausgewählten Kategorien muss eine gleichnamige Cookie-Gruppe in jeder dieser Kategorien angelegt werden, damit der Trackingcode dort im Banner sichtbar ist.'),
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => 'matomo_cookieless',
                        'type' => 'select',
                        'label' => __('Cookieloses Tracking'),
                        'description' => __('Bestimmt, ob mit oder ohne Cookies getrackt wird oder ob auf cookieloses Tracking zurückgegriffen werdem soll, wenn kein Consent vorliegt.'),
                        'notes' => __('Das cookielose Tracking ist auch **ohne** ausdrücklicher Zustimmung DSGVO-konform. '),
                        'columnWidth' => 60,
                        'options' => [
                            '' => __('Kein cookieloses Tracking'),
                            'fallback' => __('Auf cookieloses Tracken zurückfallen'),
                            'cookieless' => __('Ausschließliches cookielose Tracken'),
                        ],
                        'value' => '',
                        'showIf' => 'matomo_enabled=1',
                    ],
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'children' => [
                            [
                                'name' => 'meta_pixel_cookie_category',
                                'type' => 'asmSelect',
                                'label' => __('Cookie-Kategorien'),
                                'description' => __('Cookie-Kategorien, denen dieser Trackingcode zugehörig ist. Es können mehrere Kategorien ausgewählt werden.'),
                                'notes' => __('ODER-Verknüpfung: Der Trackingcode wird geladen, sobald einer der ausgewählten Kategorien zugestimmt wurde. Wird keine Kategorie ausgewählt, wird der Trackingcode ausgegeben, wenn den Statistik-Cookies zugestimmt wird.'),
