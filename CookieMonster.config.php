                            ...
                            [
                                ...
                                'children' => [
                                    [
                                        ...
                                        'type' => 'select',
                                        'label' => __('Cookie-Kategorie'),
                                        'description' => __('Cookie-Kategorie aus, welche zugehörig zum Trackingcode ist.'),
                                        'notes' => __('Ist keine Kategorie ausgewählt, wird der Trackingcode ausgegeben, wenn den Statistik-Cookies zugestimmt wird.'),
                                        'columnWidth' => 50,
                                        'options' => [
                                            '' => __('Nicht gesetzt (Statistik-Cookies)'),
                                    ...
                                    [
                                        ...
                                        'notes' => __('Die ID muss mit der ID des Cookies bzw. der Cookie-Gruppe (`Name`) übereinstimmen.'),
                                        'columnWidth' => 50,
                                        'showIf' => 'ga_cookie_category!=""',
                                        'value' => '',
                                    ],
                                ],
                            ],
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            [
                                ...
                                'notes' => __('Die ID muss mit der ID des Cookies bzw. der Cookie-Gruppe (`Name`) übereinstimmen.'),
                                'columnWidth' => 50,
                                'showIf' => 'linkedin_insight_cookie_category!=""',
                                'value' => '',
                            ],
                        ],
                    ],
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            [
                                ...
                                'notes' => __('Die ID muss mit der ID des Cookies bzw. der Cookie-Gruppe (`Name`) übereinstimmen.'),
                                'columnWidth' => 50,
                                'showIf' => 'meta_pixel_cookie_category!=""',
                                'value' => '',
                            ],
                        ],
                    ],
