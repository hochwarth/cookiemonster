			...
			[
				...
				'children' => [
					...
					[
						...
						'value' => "wires|example.com|Der Cookie ist für die sichere Anmeldung und die Erkennung von Spam oder Missbrauch der Webseite erforderlich.|Sitzung\ncmnstr|example.com|Speichert den Zustimmungsstatus des Benutzers für Cookies.|180 Tag(e)\n---eyeable|Eye-Able Overlay|Eye-Able Overlay stellt Funktionen zur Verbesserung der digitalen Zugänglichkeit und Benutzerfreundlichkeit der Webseite bereit.\neyeAbleVariables|example.com|Speichert die Voreinstellungen des Besuchers.|Beständig",
						'useLanguages' => true,
						'columnWidth' => 100,
						'rows' => 5,
					],
