            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'placeholder' => __('Notwendig für die Website-Funktion (z.B. Session-IDs, CSRF-Schutz). Nicht deaktivierbar. Die Website funktioniert ohne diese nicht.'),
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 3,
                    ],
                    [
                        ...
                        'label' => __('Cookies'),
                        'description' => __('Format: Name|Anbieter|Zweck|Dauer (Ein Cookie pro Zeile)'),
                        'notes' => __('Beispiel: sessionid|example.com|Benutzer-Session|Session'),
                        'placeholder' => "wire|my-domain.de|Session-Identifikator|Session\ncsrf|my-domain.de|CSRF-Schutz|Session",
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 5,
                    ],
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'type' => 'textarea',
                        'label' => __('Kategorie-Beschreibung'),
                        'placeholder' => __('Aktivieren erweiterte Features wie Spracheinstellung oder Dark Mode. Beispiele: Theme-Einstellung (Light/Dark), Gespeicherte Sprachauswahl. Verbessert die Nutzererfahrung, ist aber nicht zwingend erforderlich.'),
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 3,
                        'showIf' => 'functional_enabled=1',
                    ...
                    [
                        ...
                        'label' => __('Cookies'),
                        'description' => __('Format: Name|Anbieter|Zweck|Dauer (Ein Cookie pro Zeile)'),
                        'notes' => __('Beispiel: lang|example.com|Sprachauswahl|1 Jahr'),
                        'placeholder' => "language|my-domain.de|Gespeicherte Sprache des Benutzers|1 Jahr\ntheme|my-domain.de|Bevorzugtes Farbschema (Dark/Light)|1 Jahr",
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 5,
                        'showIf' => 'functional_enabled=1',
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'type' => 'textarea',
                        'label' => __('Kategorie-Beschreibung'),
                        'placeholder' => __('Für anonyme Nutzungsanalysen. Beispiele: Google Analytics (Seitenaufrufe, Verweildauer), Matomo (Besucherstatistiken). Helfen uns, die Website zu verbessern, ohne persönliche Daten zu sammeln.'),
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 3,
                        'showIf' => 'statistics_enabled=1',
                    ...
                    [
                        ...
                        'label' => __('Cookies'),
                        'description' => __('Format: Name|Anbieter|Zweck|Dauer (Ein Cookie pro Zeile)'),
                        'notes' => __('Beispiel: _ga|Google Analytics|Eindeutige Benutzer-ID|2 Jahre'),
                        'placeholder' => "_ga|Google Analytics|Eindeutige Benutzer-ID|400 Tage\n_gat|Google Analytics|Anfragerate-Limitierung|1 Tag",
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 5,
                        'showIf' => 'statistics_enabled=1',
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'type' => 'textarea',
                        'label' => __('Kategorie-Beschreibung'),
                        'placeholder' => __('Für personalisierte Werbung und Remarketing. Beispiele: Facebook Pixel (Zielgruppenbau, Conversions), Google Ads (Kampagnen-Tracking). Verfolgen deine Aktivitäten über verschiedene Websites.'),
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 3,
                        'showIf' => 'marketing_enabled=1',
                    ...
                    [
                        ...
                        'label' => __('Cookies'),
                        'description' => __('Format: Name|Anbieter|Zweck|Dauer (Ein Cookie pro Zeile)'),
                        'notes' => __('Beispiel: _fbp|Facebook|Remarketing|3 Monate'),
                        'placeholder' => "_fbp|Facebook|Remarketing & Conversion Tracking|3 Monate\n_gac|Google Ads|Kampagnen-Tracking & Conversions|90 Tage",
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 5,
                        'showIf' => 'marketing_enabled=1',
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'type' => 'textarea',
                        'label' => __('Kategorie-Beschreibung'),
                        'placeholder' => __('Externe Services setzen zusätzliche Cookies. Beispiele: YouTube Videos (Tracking, Personalisierung), Google Maps (Standortdaten). Diese Anbieter können Daten außerhalb der Website verarbeiten.'),
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 3,
                        'showIf' => 'external_enabled=1',
                    ...
                    [
                        ...
                        'label' => __('Inhalte'),
                        'description' => __('Format: Name|Anbieter|Zweck|Dauer (Ein Cookie pro Zeile)'),
                        'notes' => __('Beispiel: PREF|YouTube|Video-Einstellungen|8 Monate'),
                        'placeholder' => "PREF|YouTube|Video-Einstellungen & Tracking|400 Tage\nLOGIN_INFO|YouTube|Authentifizierung & Personalisierung|400 Tage",
                        'useLanguages' => true,
                        'columnWidth' => 100,
                        'rows' => 5,
                        'showIf' => 'external_enabled=1',
